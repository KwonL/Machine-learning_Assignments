...
sample_input, sample_output = get_train_batch(batch_size = 10)
...
# seq.fit(noisy_movies, shifted_movies, batch_size=5,
#         epochs=300, validation_split=0.05)

training_generator = DataGenerator(batch_size=2, batch_num_per_epoch=500)
validation_generator = ValidGenerator(batch_size=2)
seq.fit_generator(
